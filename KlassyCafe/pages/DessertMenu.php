	...
	<div class="menu"  style="margin-top:-8%;">
            <div class="container">
                <div class="section-header text-center">
                    <p>Dessert Menu</p>
                    <h2>Sweeties Dessert Menu</h2>
                </div>
                <div class="menu-tab">
                    <div class="tab-content">
                        <div id="snacks" class="container tab-pane active">
                            <div class="row">
                                <div class="col-lg-7 col-md-12">
								
                                    <?php
									error_reporting(0);
									$xml = "SELECT * FROM tbl_food WHERE cid = 'dessert' AND trash=0 order by id desc";
                                ...
                                <div class="col-lg-5 d-none d-lg-block">
                                    <img src="img/menu-dessert.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
