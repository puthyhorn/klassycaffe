...
<head>
  ...
  <title>Klassy Cafe Admin Sites</title>
...
<body>
  ...
  <!-- ======= Header ======= -->
  <?php
	include "pages/headfoot/header.php";
  ?>
  <!-- End Header -->

  <!-- ======= Sidebar ======= -->
  <?php
		include "pages/headfoot/sidebar.php";
?>
  <!-- End Sidebar-->
  ...
  <main id="main" class="main">
	...
	<?php	
				...
				{
					require "pages/contact/".$_GET['pc'].".php";
				}
				else
				{
...
<div style="position:fixed;left:0;bottom:0;width:100%;text-align:center;">
  <!-- ======= Footer ======= -->
  <?php
		//include"pages/headfoot/footer.php";
	?>
  <!-- End Footer -->
</div>
